...
//call the cypher class and the cypher method that contains the hash map <string, character>
 cypher.createCypher();
 ...
 try {
  ...
  /**
   * When the user clicks the button a file is read and encrypted text file is created
   * @param event 
   */
 @FXML
 ...
 //Clear the text box 
 codedText.setText("");
 //Call the readFromFile method that reads the text file and converts it to encrypted text
readFromFile();
